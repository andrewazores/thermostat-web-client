...
describe('JvmMemoryRouting', () => {

  let module = require('./jvm-memory.routing.js');
  ...
  describe('stateProvider', () => {
    ...
    it('should define a \'jvmInfo.jvmMemory\' state', () => {
      args[0].should.equal('jvmInfo.jvmMemory');
    });

    it('should map to /jvm-memory', () => {
